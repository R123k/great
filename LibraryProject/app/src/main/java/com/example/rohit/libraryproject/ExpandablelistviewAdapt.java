...
public class ExpandablelistviewAdapt extends BaseExpandableListAdapter {
    ...
    public ExpandablelistviewAdapt(Context context, List<String> listheader, LinkedHashMap<String, List<String>> listHashMap) {
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        {
            LayoutInflater inflater = (LayoutInflater)this.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = inflater.inflate(R.layout.listchildren,null);
        }
